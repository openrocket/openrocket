...
* Main loader: :file:`core/src/main/java/info/openrocket/core/file/openrocket/importt/OpenRocketLoader.java`
* Content handler: :file:`core/src/main/java/info/openrocket/core/file/openrocket/importt/OpenRocketContentHandler.java`
* Component handlers: :file:`core/src/main/java/info/openrocket/core/file/openrocket/importt/ComponentHandler.java`
* Parameter handlers: :file:`core/src/main/java/info/openrocket/core/file/openrocket/importt/ComponentParameterHandler.java`
* Specialized handlers: Various handler classes in the :file:`importt/` directory (e.g., :file:`SimulationConditionsHandler.java`, :file:`WindHandler.java`, :file:`MotorHandler.java`)

**Writing (Rocket model → .ork):**

* Main saver: :file:`core/src/main/java/info/openrocket/core/file/openrocket/OpenRocketSaver.java`
* Component savers: :file:`core/src/main/java/info/openrocket/core/file/openrocket/savers/` directory
* Base saver: :file:`core/src/main/java/info/openrocket/core/file/openrocket/savers/RocketComponentSaver.java`
* Specific component savers: Individual saver classes for each component type (e.g., :file:`NoseConeSaver.java`, :file:`BodyTubeSaver.java`, :file:`FinSetSaver.java`)
...
* Main loader: :file:`core/src/main/java/info/openrocket/core/preset/xml/OpenRocketComponentLoader.java`
* Root DTO: :file:`core/src/main/java/info/openrocket/core/preset/xml/OpenRocketComponentDTO.java`
* Component DTOs: Individual DTO classes for each component type (e.g., :file:`BodyTubeDTO.java`, :file:`NoseConeDTO.java`, :file:`ParachuteDTO.java`)
* Material DTO: :file:`core/src/main/java/info/openrocket/core/preset/xml/MaterialDTO.java`
* Base component DTO: :file:`core/src/main/java/info/openrocket/core/preset/xml/BaseComponentDTO.java`

**Writing (ComponentPreset objects → .orc):**

* Main saver: :file:`core/src/main/java/info/openrocket/core/preset/xml/OpenRocketComponentSaver.java`
* Uses JAXB marshalling from the same DTO classes listed above

.. note::

   The .orc file format uses JAXB (Jakarta XML Binding) annotations for serialization/deserialization, while the .ork
   format uses SAX parsing for reading and direct XML writing for saving.
