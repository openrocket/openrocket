...
public class TextUtilTest {
	...
	public void longTest() {
		...
		assertEquals(TextUtil.doubleToString(PI * 1.0e-5), "3.142e-5");
		assertEquals(TextUtil.doubleToString(PI * 1.0e-4), "3.142e-4");
		assertEquals(TextUtil.doubleToString(PI * 1.0e-3), "0.003");
		assertEquals(TextUtil.doubleToString(PI * 1.0e-2), "0.031");
		assertEquals(TextUtil.doubleToString(PI * 1.0e-1), "0.314");
		assertEquals(TextUtil.doubleToString(PI), "3.142");
		assertEquals(TextUtil.doubleToString(PI * 1.0e1), "31.416");
		assertEquals(TextUtil.doubleToString(PI * 1.0e2), "314.159");
		assertEquals(TextUtil.doubleToString(PI * 1.0e3), "3141.593");
		assertEquals(TextUtil.doubleToString(PI * 1.0e4), "3.142e4");
		assertEquals(TextUtil.doubleToString(PI * 1.0e5), "3.142e5");
		assertEquals(TextUtil.doubleToString(PI * 1.0e6), "3.142e6");
		assertEquals(TextUtil.doubleToString(PI * 1.0e7), "3.142e7");
		assertEquals(TextUtil.doubleToString(PI * 1.0e8), "3.142e8");
		assertEquals(TextUtil.doubleToString(PI * 1.0e9), "3.142e9");
		assertEquals(TextUtil.doubleToString(PI * 1.0e10), "3.142e10");
	...
	public void shortTest() {
		double p = 3.1;
		assertEquals(TextUtil.doubleToString(p * 1.0e-5), "3.1e-5");
		assertEquals(TextUtil.doubleToString(p * 1.0e-4), "3.1e-4");
		assertEquals(TextUtil.doubleToString(p * 1.0e-3), "0.003");
		assertEquals(TextUtil.doubleToString(p * 1.0e-2), "0.031");
		assertEquals(TextUtil.doubleToString(p * 1.0e-1), "0.31");
		assertEquals(TextUtil.doubleToString(p), "3.1");
		assertEquals(TextUtil.doubleToString(p * 1.0e1), "31");
		assertEquals(TextUtil.doubleToString(p * 1.0e2), "310");
		assertEquals(TextUtil.doubleToString(p * 1.0e3), "3100");
		assertEquals(TextUtil.doubleToString(p * 1.0e4), "3.1e4");
		assertEquals(TextUtil.doubleToString(p * 1.0e5), "3.1e5");
		assertEquals(TextUtil.doubleToString(p * 1.0e6), "3.1e6");
		assertEquals(TextUtil.doubleToString(p * 1.0e7), "3.1e7");
		assertEquals(TextUtil.doubleToString(p * 1.0e8), "3.1e8");
		assertEquals(TextUtil.doubleToString(p * 1.0e9), "3.1e9");
		assertEquals(TextUtil.doubleToString(p * 1.0e10), "3.1e10");
		...
		p = 3;
		assertEquals(TextUtil.doubleToString(p * 1.0e-5), "3e-5");
		assertEquals(TextUtil.doubleToString(p * 1.0e-4), "3e-4");
		assertEquals(TextUtil.doubleToString(p * 1.0e-3), "0.003");
		assertEquals(TextUtil.doubleToString(p * 1.0e-2), "0.03");
		assertEquals(TextUtil.doubleToString(p * 1.0e-1), "0.3");
		assertEquals(TextUtil.doubleToString(p), "3");
		assertEquals(TextUtil.doubleToString(p * 1.0e1), "30");
		assertEquals(TextUtil.doubleToString(p * 1.0e2), "300");
		assertEquals(TextUtil.doubleToString(p * 1.0e3), "3000");
		assertEquals(TextUtil.doubleToString(p * 1.0e4), "3e4");
		assertEquals(TextUtil.doubleToString(p * 1.0e5), "3e5");
		assertEquals(TextUtil.doubleToString(p * 1.0e6), "3e6");
		assertEquals(TextUtil.doubleToString(p * 1.0e7), "3e7");
		assertEquals(TextUtil.doubleToString(p * 1.0e8), "3e8");
		assertEquals(TextUtil.doubleToString(p * 1.0e9), "3e9");
		assertEquals(TextUtil.doubleToString(p * 1.0e10), "3e10");
