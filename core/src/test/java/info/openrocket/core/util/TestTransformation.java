...
public class TestTransformation {
	static final Coordinate x_unit = ImmutableCoordinate.X_UNIT;
	static final Coordinate y_unit = ImmutableCoordinate.Y_UNIT;
	static final Coordinate z_unit = ImmutableCoordinate.Z_UNIT;
	...
	public void testTransformTranslationIndividual() {
		...
		assertEquals(new ImmutableCoordinate(2, 2, 3), translate.transform(x_unit));
		assertEquals(new ImmutableCoordinate(1, 3, 3), translate.transform(y_unit));
		assertEquals(new ImmutableCoordinate(1, 2, 4), translate.transform(z_unit));
	}

	@Test
	public void testTransformTranslationCoordinate() {
		Transformation translate = new Transformation(new ImmutableCoordinate(2, 3, 4));

		assertEquals(new ImmutableCoordinate(3, 3, 4), translate.transform(x_unit));
		assertEquals(new ImmutableCoordinate(2, 4, 4), translate.transform(y_unit));
		assertEquals(new ImmutableCoordinate(2, 3, 5), translate.transform(z_unit));
	}
	...
	public void testTransformEuler313Transform() {
		...
		}
		{
			...
			// precision = 8 decimal places
			assertEquals(new ImmutableCoordinate(+0.500000, +0.500000, 0.707106781), r313.transform(x_unit));
			assertEquals(new ImmutableCoordinate(-0.500000, -0.5000000, 0.707106781), r313.transform(y_unit));
			assertEquals(new ImmutableCoordinate(+0.707106781, -0.707106781, 0.0), r313.transform(z_unit));
		}
	}
	...
	public void testTransformEuler121Transform() {
		...
		assertEquals(new ImmutableCoordinate(+0.540275291, +0.450102302, -0.710992634), r123.transform(x_unit));
		assertEquals(new ImmutableCoordinate(-0.841428912, +0.299007198, -0.450102302), r123.transform(y_unit));
		assertEquals(new ImmutableCoordinate(+0.009999833334, +0.841428911609, +0.540275290977), r123.transform(z_unit));
	...
	public void testTransformRotateTranslate() {
		...
		assertEquals(new ImmutableCoordinate(3, 3, 4), r.transform(x_unit));
		assertEquals(new ImmutableCoordinate(2, 3, 5), r.transform(y_unit));
		assertEquals(new ImmutableCoordinate(2, 2, 4), r.transform(z_unit));
	}
