...
public class TestFlightData {
	...
	/**
	 * Test method for
	 * {@link info.openrocket.core.simulation.FlightData#FlightData()}.
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link info.openrocket.core.simulation.FlightData#FlightData(info.openrocket.core.simulation.FlightDataBranch[])}.
	 */
	@Test
	...
	private FlightDataBranch createFlightDataBranch(final String name, final FlightDataType dataType,
			final double[] values) {
	...
	/**
	 * Test method for
	 * {@link info.openrocket.core.simulation.FlightData#getMaxAltitude()}.
	 */
	@Test
	public void testGetMaxAltitudeCalculated() {
		...
		FlightDataBranch branch = createFlightDataBranch("Test Max Alt", FlightDataType.TYPE_ALTITUDE, altitudes);
	...
	/**
	 * Test method for
	 * {@link info.openrocket.core.simulation.FlightData#getMaxVelocity()}.
	 */
	@Test
	public void testGetMaxVelocityCalculated() {
		...
		FlightDataBranch branch = createFlightDataBranch("Test Max Velocity", FlightDataType.TYPE_VELOCITY_TOTAL,
				velocities);
	...
	/**
	 * Test method for
	 * {@link info.openrocket.core.simulation.FlightData#getMaxMachNumber()}.
	 */
	@Test
	public void testGetMaxMachNumberCalculated() {
		...
		FlightDataBranch branch = createFlightDataBranch("Test Max Mach", FlightDataType.TYPE_MACH_NUMBER, machs);
	...
	/**
	 * Test method for
	 * {@link info.openrocket.core.simulation.FlightData#getFlightTime()}.
	 */
	@Test
	public void testGetFlightTime() {
		...
		FlightDataBranch branch = createFlightDataBranch("Test Flight Time", FlightDataType.TYPE_TIME, times);
	...
	/**
	 * Test method for
	 * {@link info.openrocket.core.simulation.FlightData#getGroundHitVelocity()}.
	 */
	@Test
	public void testGetGroundHitVelocity() {
		...
		FlightDataBranch branch = new FlightDataBranch("Ground Hit Velocities",
