...
public class RASAeroHandler extends AbstractElementHandler {
    ...
    private static class RocketDocumentHandler extends AbstractElementHandler {
        ...
        public RocketDocumentHandler(DocumentLoadingContext context, String rocketName) {
            ...
            final AxialStage stage = new AxialStage();  // The first stage in RASAero is not explicitly defined, so add it here
        ...
        public void closeElement(String element, HashMap<String, String> attributes, String content, WarningSet warnings) throws SAXException {
            /*
             * SAX handler for RASAero file version number.  The value is not used currently, but could be used in the future
