...
public class TransitionHandler extends BaseHandler<Transition> {
     ...
     */
    public TransitionHandler(DocumentLoadingContext context, RocketComponent parent, WarningSet warnings) throws IllegalArgumentException {
        super(context);
        if (parent == null) {
        ...
        if (isCompatible(parent, Transition.class, warnings)) {
            ...
            throw new IllegalArgumentException("Cannot add transition to parent of type " + parent.getClass().getName());
        }
