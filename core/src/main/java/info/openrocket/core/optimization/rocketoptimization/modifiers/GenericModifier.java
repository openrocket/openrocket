...
/**
 * A generic SimulationModifier that uses reflection to get and set a double
 * value.
 * Implementations need to implement the {@link #getModifiedObject(Simulation)}
 * method
...
public abstract class GenericModifier<T> extends AbstractSimulationModifier {
	 ...
	 * @param modifiedClass       the class type that
	 *                            {@link #getModifiedObject(Simulation)} returns
	...
	public void modify(Simulation simulation, double scaledValue) throws OptimizationException {
		...
		log.trace("Setting setter=" + setter + " modifiable=" + modifiable + " siValue=" + siValue + "scaledValue="
				+ scaledValue);
	...
	public String toString() {
		return "GenericModifier[modifiedClass=" + modifiedClass.getCanonicalName() + ", methodName=" + methodName
