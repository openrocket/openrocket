...
/**
 * A FunctionCache that allows scheduling points to be computed in the
 * background,
...
public interface ParallelFunctionCache extends FunctionCache {
	 ...
	 * @throws InterruptedException  if this thread or the computing thread was
	 *                               interrupted while waiting.
	 * @throws OptimizationException if an error preventing continuing the
	 *                               optimization occurs.
	 */
	 ...
	 * @return <code>true</code> if the point has been computed anyway,
