...
/**
 * An OptimizationController that delegates control actions to multiple other
 * controllers.
...
public class OptimizationControllerDelegator implements OptimizationController {
	...
	/**
	 * Control whether to continue optimization. This method returns false if any of
	 * the
	 * used controllers returns false. However, all controllers will be called even
	 * if
