...
public interface FunctionOptimizer {
	...
	/**
	 * Perform optimization on the function. The optimization control is called to
	 * control
	...
	/**
	 * Return the optimum point computed by
	 * {@link #optimize(Point, OptimizationController)}.
	 * 
