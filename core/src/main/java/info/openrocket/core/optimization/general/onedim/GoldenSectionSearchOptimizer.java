package info.openrocket.core.optimization.general.onedim;
 ...
 * (see e.g. Nonlinear programming, Bazaraa, Sherall, Shetty, 2nd edition, p.
 * 270)
 * <p>
 * This implementation attempts to guess future evaluations and computes them in
 * parallel
 * with the next point.
 * <p>
