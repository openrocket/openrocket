...
/**
 * An abstract implementation of the SimulationModifier interface. An
 * implementation
 * needs only to implement the {@link #getCurrentSIValue(Simulation)} and
 * {@link #modify(info.openrocket.core.document.Simulation, double)} methods.
 * 
...
public abstract class AbstractSimulationModifier implements SimulationModifier {
	...
	/**
	 * Returns the scaled value (normally within [0...1]). If the min...max range is
	 * singular,
	 * this method returns 0.0, 1.0 or 0.5 depending on whether the value is less
	 * than,
