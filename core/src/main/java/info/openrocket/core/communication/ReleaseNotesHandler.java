 ...
 * <p>
 * Releases are stored in an HTML <div> object with as id attribute the release
 * version.
...
public class ReleaseNotesHandler extends AbstractElementHandler {
    ...
    /**
     * @param buildVersion the build version to search the release notes for (e.g.
     *                     "22.02")
     */
    ...
    public ElementHandler openElement(String element, HashMap<String, String> attributes, WarningSet warnings)
            throws SAXException {
        if (element.equals("body")) { // The release notes are encapsulated in a root <body> tag (required for XML
                                      // parsing)
            return this;
        }
