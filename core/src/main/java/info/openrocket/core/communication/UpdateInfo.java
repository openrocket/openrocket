...
import info.openrocket.core.communication.UpdateInfoRetriever.UpdateInfoFetcher.UpdateCheckerException;
...
public class UpdateInfo {
	...
	private final UpdateCheckerException exception; // Exception that was thrown during the release fetching process. If
													// null, the fetching was successful.

	/**
	 * Constructor for when a valid release is found.
	 * 
	 * @param latestRelease the release info object of the latest GitHub release
	 * @param releaseStatus the release status of the current build version compared
	 *                      to the latest GitHub release version
	 */
	...
	/**
	 * Get the release status of the current build version compared to the latest
	...
	/**
	 * Get the exception that was thrown when fetching the latest release. If the
	 * fetching was successful, null is returned.
	 * 
	 * @return UpdateCheckerException exception that was thrown when fetching the
	 *         release. Null if fetching was successful
	 */
	...
	public String toString() {
		return "UpdateInfo[releaseStatus=" + releaseStatus + "; latestRelease="
				+ (latestRelease == null ? "null" : latestRelease.toString()) + "]";
	}
}
