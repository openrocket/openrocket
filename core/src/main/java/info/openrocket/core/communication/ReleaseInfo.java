 ...
 * JSON objects, retrieved using the GitHub
 * releases API.
 *
 * @author Sibo Van Gool <sibo.vangool@hotmail.com>
 */
public class ReleaseInfo {
    // GitHub release JSON object containing all the information about a certain
    // release
    // You can examine an example object here:
    // https://api.github.com/repos/openrocket/openrocket/releases/latest
     ...
     * 
     * @return release notes (this is the text that explains a certain GitHub
     *         release)
     */
     ...
     * 
     * @return list of asset download URLs (e.g.
     *         'https://github.com/openrocket/openrocket/releases/download/release-15.03/OpenRocket-15.03-installer.exe')
     */
