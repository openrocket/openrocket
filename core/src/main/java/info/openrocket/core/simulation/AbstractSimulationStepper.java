...
public abstract class AbstractSimulationStepper implements SimulationStepper {
	...
	/**
	 * Calculate the average thrust produced by the motors in the current
	 * configuration, allowing
	 * listeners to override. The average is taken between <code>status.time</code>
	 * and
	 * <code>status.time + timestep</code>.
	 * <p>
	 * TODO: HIGH: This method does not take into account any moments generated by
	 * off-center motors.
	 * 
	 ...
	 * @param stepMotors            whether to step the motors forward or work on a
	 *                              clone object
