...
/**
 * A simulation listener that stops the simulation after a specified number of
 * steps or
		...
		public void postStep(SimulationStatus status) throws SimulationException {
			...
			if ((step % getReportRate()) == 0) {
				...
				System.out.printf("Step %4d, time=%.3f, took %d us/step (avg. %d us/step)\n",
						step, status.getSimulationTime(), (t - time) / 1000 / getReportRate(),
						(t - startTime) / 1000 / step);
				time = t;
			}
