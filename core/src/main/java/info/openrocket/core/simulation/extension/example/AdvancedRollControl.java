...
/**
 * An example listener that applies a PID-controller with additional configurable parameters to adjust the cant of fins
 * to control the rocket's roll rate
 * 
 * @author Sampo Niskanen <sampo.niskanen@iki.fi>
 * @author Marc D Nichitiu <nichitiu@mit.edu>
 *
 *         One note: making aerodynamic changes during the simulation results in
 *         the simulation
 *         running *extremely* slowly
 */
public class AdvancedRollControl extends AbstractSimulationExtension {
