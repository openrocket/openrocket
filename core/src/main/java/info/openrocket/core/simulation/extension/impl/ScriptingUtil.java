...
public class ScriptingUtil {
	...
	/**
	 * The name to be chosen from a list of alternatives. If not found, will use the
	 * default name.
	 */
	...
	public ScriptingUtil() {
		if (manager == null) {
			// using the ScriptEngineManger from javax.script package pulls in the
			// sun.misc.ServiceConfigurationError
			// which is removed in Java 9+ which causes a ClassNotFoundException to be
			// thrown.
	 ...
	 * 
	 * @return the preferred language name, or null if the language is not
	 *         supported.
	 */
