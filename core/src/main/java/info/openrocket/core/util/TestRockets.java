...
public class TestRockets {
	public final static FlightConfigurationId TEST_FCID_0 = new FlightConfigurationId(
			"d010716e-ce0e-469d-ae46-190f3653ebbf");
	public final static FlightConfigurationId TEST_FCID_1 = new FlightConfigurationId(
			"f41bee5b-ebb8-4d92-bce7-53001577a313");
	public final static FlightConfigurationId TEST_FCID_2 = new FlightConfigurationId(
			"3e8d1280-53c2-4234-89a7-de215ef5cd69");
	public final static FlightConfigurationId TEST_FCID_3 = new FlightConfigurationId(
			"415a5485-f2da-4c2a-8803-394220ae58b8");
	public final static FlightConfigurationId TEST_FCID_4 = new FlightConfigurationId(
	...
	/**
	 * Create a new test rocket based on the value 'key'. The rocket utilizes most
	 * of the
	 * properties and features available. The same key always returns the same
	 * rocket,
	 ...
	 * <p>
	 * The rocket created by this method is not fly-worthy. It is also NOT
	 * guaranteed
	...
	public static final Rocket makeEstesAlphaIII() {
		...
		// preserve default default configuration of rocket -- to test what the default
		// is set to upon initialization.
	...
	// This is not a production rocket -- it is construction, purely for testing
	// Mass Overrides
	// This function is used for unit, integration tests, DO NOT CHANGE (without
	// updating tests).
	...
	public static Rocket makeBigBlue() {
		...
		// System.err.println("Fin cant angle: " + (finset.getCantAngle() * 180 /
		// Math.PI));
		...
		// Motor m = Application.getMotorSetDatabase().findMotors(null, null, "F12J",
		// Double.NaN, Double.NaN).get(0);
	...
	public static Rocket makeIsoHaisu() {
		...
		// Motor m = Application.getMotorSetDatabase().findMotors(null, null, "L540",
		// Double.NaN, Double.NaN).get(0);
		// tube3.setMotor(id, m);
			...
			// cp:(0.96400,0.00000,0.00000)
			{
...

				{
					...
					// cp:(0.96400,-0.07700,0.00000)
					{
						...
						// boosterMotorTubes.setClusterConfiguration(
						// ClusterConfiguration.CONFIGURATIONS[13]); // 9-star
	...
	public static void addCoreFins(Rocket rocket) {
		...
		final TrapezoidFinSet finSet = new TrapezoidFinSet(bodyFinCount, bodyFinRootChord, bodyFinTipChord,
	...
	public static Rocket makeEndPlateRocket() {
		...
		TrapezoidFinSet bodyFinSet = new TrapezoidFinSet(bodyFinCount, bodyFinRootChord, bodyFinTipChord, bodyFinSweep,
				bodyFinHeight);
		...
		// end plates
		TrapezoidFinSet endPlate = new TrapezoidFinSet(endPlateCount, endPlateRootChord, endPlateTipChord,
				endPlateSweep, endPlateHeight);
	...
	/*
	 * Create a new file version 1.06 rocket with flight configuration with motor
	 * mount ignition configuration
	 */
	...
	/*
	 * Create a new file version 1.06 rocket with flight configuration with recovery
	 * device deployment configuration non-default
	 */
	...
	/*
	 * Create a new file version 1.06 rocket with flight configuration with stage
	...
	public static final Rocket makeEstesAlphaIIIwithInlinePod() {
		...
		// We need to reference the components hooked to the body to its aft end, not
		// forward
