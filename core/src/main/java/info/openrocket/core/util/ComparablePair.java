...
/**
 * Sortable storage of a pair of objects. A list of these objects can be sorted
 * according
 * to the first object.
 * 
 * @author Sampo Niskanen <sampo.niskanen@iki.fi>
 * @param <U> the first object type, according to which comparisons are
 *            performed.
...
public class ComparablePair<U extends Comparable<U>, V> extends Pair<U, V>
	...
	/**
	 * Compares the first objects. If either of the objects is <code>null</code>
	 * this
