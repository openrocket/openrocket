...
public class Invalidator implements Invalidatable {
	 ...
	 * 
	 * @param monitorable the object this invalidator is monitoring (may be null or
	...
	/**
	 * Check whether the object has been invalidated. Depending on the parameter
	 * either
	 ...
	 * @return <code>true</code> when the object has not been invalidated,
	 *         <code>false</code> if it has
	 * @throws BugException if the object has been invalidated and
	 *                      <code>throwException</code> is true.
	 */
	 ...
	 * 
	 * @return <code>true</code> if the object has been invalidated,
