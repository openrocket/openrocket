...
public interface CoordinateIF extends Cloneable, Serializable {
	 ...
	 */
	CoordinateIF setWeight(double weight);
	 ...
	 */
	CoordinateIF setXYZ(CoordinateIF c);
	 ...
	 */
	CoordinateIF add(CoordinateIF other);

	CoordinateIF add(double x1, double y1, double z1);

	CoordinateIF add(double x1, double y1, double z1, double w1);
	 ...
	 * @return the result
	 */
	CoordinateIF addScaled(CoordinateIF coord, double scale);
	 ...
	 * @return  The result
	 */
	CoordinateIF sub(CoordinateIF other);
	 ...
	 * @return		the result.
	 */
	CoordinateIF sub(double x1, double y1, double z1);
	 ...
	 * @return   The product.
	 */
	CoordinateIF multiply(double m);
	 ...
	 * @return   The product.
	 */
	CoordinateIF multiply(CoordinateIF other);
	 ...
	 */
	default double dot(CoordinateIF other) {
	 ...
	 */
	static double dot(CoordinateIF v1, CoordinateIF v2) {
	 ...
	 * returned.
	 */
	CoordinateIF average(CoordinateIF other);
	 ...
	 */
	CoordinateIF interpolate(CoordinateIF other, double fraction);
	...
	default Coordinate toImmutable() {
		return new Coordinate(getX(), getY(), getZ(), getWeight());
	}
