...
public final class Coordinate implements Cloneable, Serializable {
	...
	public static final Coordinate MAX = new Coordinate(Double.MAX_VALUE, Double.MAX_VALUE, Double.MAX_VALUE,
			Double.MAX_VALUE);
	...
	/**
	 * Subtract a Coordinate from this Coordinate. The weight of the resulting
	 * Coordinate
	 * is the same as of this Coordinate; i.e. the weight of the argument is
	 * ignored.
	 * 
	 ...
	 * the result is the weighted average of the coordinates and the weight is the
	 * sum
	 ...
	 * <p>
	 * If <code>other</code> is <code>null</code> then this <code>Coordinate</code>
	 * is
	 * returned.
	 */
