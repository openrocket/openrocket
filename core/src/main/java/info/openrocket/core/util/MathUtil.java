...
public class MathUtil {
	...
	/**
	 * The square of x (x^2). On Sun's JRE using this method is as fast as typing
	 * x*x.
	 * 
	 * @param x x
	 * @return x^2
	 ...
	 * @throws IllegalArgumentException if fromMin == fromMax, but toMin != toMax.
	 */
	public static CoordinateIF map(double value, double fromMin, double fromMax,
								   CoordinateIF toMin, CoordinateIF toMax) {
	 ...
	 * However, if one of the values is NaN and the other is not, the non-NaN value
	 * is
	 * returned.
	 */
	...
	/**
	 * Calculates the hypotenuse <code>sqrt(x^2+y^2)</code>. This method is
	 * SIGNIFICANTLY
	...
	/**
	 * Return the square root of a value. If the value is negative, zero is
	 * returned.
	 * This is safer in cases where rounding errors might make a value slightly
	 * negative.
	 * 
	 ...
	 * @return returns Double.NaN if either list is null or empty or different size,
