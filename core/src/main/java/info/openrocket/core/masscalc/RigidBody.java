...
public class RigidBody {
	...
	public RigidBody rebase(final Coordinate newLocation) {
		...
		//
		// System.err.println(String.format(" - CM_new = %.8f @[ %.8f, %.8f, %.8f ]",
		// eachGlobal.cm.weight, eachGlobal.cm.x, eachGlobal.cm.y, eachGlobal.cm.z ));
		// System.err.println(String.format(" - each: base: { %.12f %.12f }",
		// eachLocal.xx, eachLocal.xx ));
		// System.err.println(String.format(" - each: carrected: { %.12f %.12f }",
		// eachGlobal.xx, eachGlobal.yy ));
