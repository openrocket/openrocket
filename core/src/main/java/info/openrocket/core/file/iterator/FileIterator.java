...
/**
 * An abstract class for iterating over files fulfilling some condition. The
 * files are
 * returned as pairs of open InputStreams and file names. Conditions can be for
 * example
 * files in a directory matching a specific FileFilter.
 * <p>
 * Concrete implementations must implement the method {@link #findNext()} and
 * possibly
 * {@link #close()}.
 * 
