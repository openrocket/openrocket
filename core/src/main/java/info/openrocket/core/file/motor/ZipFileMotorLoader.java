...
import info.openrocket.core.file.UnknownFileTypeException;
import info.openrocket.core.motor.ThrustCurveMotor;
import info.openrocket.core.util.UncloseableInputStream;
...
public class ZipFileMotorLoader implements MotorLoader {
	...
	/**
	 * Constructs a ZipFileMotorLoader that loads files using the provided motor
	 * loader.
	 * 
	...
	@Override
	public List<ThrustCurveMotor.Builder> load(InputStream stream, String filename)
