...
public class EngineSetDTO {
	...
	@JacksonXmlProperty(localName = RockSimCommonConstants.ENGINE_COUNT)
	private final int engineCount = 1;
	@JacksonXmlProperty(localName = RockSimCommonConstants.ENGINE_CODE)
	private String engineCode = "";
	@JacksonXmlProperty(localName = RockSimCommonConstants.IGNITION_DELAY)
	private double ignitionDelay;
	@JacksonXmlProperty(localName = RockSimCommonConstants.ENGINE_MFG)
	private String engineManufacturer = "";
	@JacksonXmlProperty(localName = RockSimCommonConstants.ENGINE_OVERHANG)
	private double engineOverhang;
	@JacksonXmlProperty(localName = RockSimCommonConstants.CASING_CG)
	private final double casingCG = 0.0;
	@JacksonXmlProperty(localName = RockSimCommonConstants.MOUNT_SERIAL_NUMBER)
	private int mountSerialNumber;
	@JacksonXmlProperty(localName = RockSimCommonConstants.EJECTION_DELAY)
	private double ejectionDelay;
	@JacksonXmlProperty(localName = RockSimCommonConstants.ROTATE_X_ABOUT_Y)
	private final double rotateXAboutY = 0.0;
	@JacksonXmlProperty(localName = RockSimCommonConstants.ROTATE_ENGINE_AXIS_ABOUT_X)
