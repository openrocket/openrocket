...
public class InnerBodyTubeDTO extends BodyTubeDTO implements AttachableParts {
	 ...
	 *               InnerTube's parent. This instance
	 *               is a member of those attached parts, as well as all sibling
	 *               components. This is passed in the
	 *               event that the inner tube is a cluster. In that situation this
	 *               instance will be removed and
	...
	/**
	 * Handle the inner tube as a cluster. This amounts to splitting it up so that
	 * each motor mount in the cluster
