...
public class ObjUtils {
    ...
    public enum LevelOfDetail {
        ...
        /**
         * Get a dynamic estimate of the number of sides (= vertices in a perfect
         * circle) to be used for the given radius.
         * 
        ...
        public int getNrOfSides(double radius) {
            ...
            final double refRadius = 0.05; // Reference radius for the number of sides (the "most common radius") <--
                                           // very arbitrary, oh well.
    ...
    /**
     * Translates the vertices in the obj file so that the component is at the
     ...
     * @param translation The translation coordinates to translate the component
     *                    with (in OpenRocket coordinate system)
     */
    public static void translateVerticesFromComponentLocation(DefaultObj obj, CoordTransform transformer,
        ...
        ObjUtils.translateVertices(obj, startIdx, endIdx, translatedLoc.getX(), translatedLoc.getY(),
                translatedLoc.getZ());
    }
    ...
    public static void rotateVertices(DefaultObj obj, int verticesStartIdx, int verticesEndIdx,
        ...
        for (int i = normalsStartIdx; i <= normalsEndIdx; i++) {
            // We don't need to consider the rotation origin for normals, since they are
            // unit vectors
     ...
     * This is useful for making sure that the object is centered at the origin. By
     * default, every component is exported
     * in the position that it is in the rocket. This may not be useful for
    ...
    public static void removeVertexOffset(DefaultObj obj, CoordTransform transformer) {
        ...
        // Adjust the min/max values based on the axial axis so that in the offset
        // calculations, one of the two
        // cancels out. This is necessary to ensure that the rocket bottom is at the OBJ
