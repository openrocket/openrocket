 ...
 * OpenRocketDocument and
 * save it as a parameter map. This map can then later be used in the swing
 * module for getting
 * or setting the PhotoSetting. (this cumbersome solution is done because of
 * dependency reasons
