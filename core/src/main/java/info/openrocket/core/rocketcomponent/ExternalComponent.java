...
/**
 * Class of components with well-defined physical appearance and which have an
 * effect on
 * aerodynamic simulation. They have material defined for them, and the mass of
 * the component
...
public abstract class ExternalComponent extends RocketComponent {
	...
	public enum Finish {
		...
		/*
		 * The surface roughness changes are intended to begin the implementation of
		 * known values derived from
		 * the Thesis and Hoerner Fluid Dynamics. It is anticipated that the ability to
		 * enter a custom surface
		 ...
		 * after reviewing the Thesis
		 * and Hoerner Fluid Dynamics, upon which the Thesis surface roughness values
		 * were based, it was determined
		 * that the "polished" surface roughness should have been 0.5 microns. To reduce
		 * the potential for causing
		 * inadvertent errors, "POLISHED" was retained and "FINISHPOLISHED" added, with
		 * the correct values for each.
		 * "POLISHED" is now described to the user as "Aircraft sheet-metal" with a
		 * value of 2.0 microns and
		 * "FINISHPOLISHED" is now described to the user as "Polished" with a value of
		 * 0.5 microns.
		 */
	...
	/**
	 * Returns the volume of the component. This value is used in calculating the
	 * mass
	 * of the object.
	 */
	...
	/**
	 * Calculates the mass of the component as the product of the volume and
	 * interior density.
	 */
	@Override
