...
public interface MotorMount extends ChangeSource, FlightConfigurableComponent {
	...
	/**
	 * Programmatically : implementing classes will always be
	 * <code>(x instanceof MotorMount)</code>
	 * The component may potentially act as a mount, or just a structural component.
	 * This flag indicates how the component behaves.
	 * 
	 * @param acting if the component should behave like a motor mount. False if
	 ...
	 * Programmatically : implementing classes will always be
	 * <code>(x instanceof MotorMount)</code>
	 * This flag indicates whether the component is acting as a motor mount, or just
	...
	/**
	 * Get the length of this motor mount. Synonymous with the RocketComponent
	 * method.
	 * 
	 * @return
	 */
	 ...
	 * @return requested motorInstance (which may also be the default motor
	 *         instance)
	 */
	...
	/**
	 * 
	 * @param fcid             index the supplied motor against this flight
	 *                         configuration
