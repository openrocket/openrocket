...
/**
 * This component handles the necessary functionalities of an
...
public class InsideColorComponentHandler {
    ...
    private boolean edgesSameAsInside = false; // Flag for setting the edge appearance to the inside (true) or outside
                                               // (false) appearance
    ...
    /**
     * Checks whether the component uses for the edges the same appearance as the
     * inside (return true) or as the
    ...
    /**
     * Checks whether the component should use a separate appearance for the inside
     * and outside.
     *
