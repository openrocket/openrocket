...
public class TubeFinSet extends Tube implements AxialPositionable, BoxBounded, RingInstanceable, InsideColorComponent {
	...
	/**
	 * Set the outer radius of the tube-fin. If the radius is less than the wall
	 * thickness,
	...
	public double getLongitudinalUnitInertia() {
		...
		final double inertia = (3 * (MathUtil.pow2(getOuterRadius()) + MathUtil.pow2(getInnerRadius()))
