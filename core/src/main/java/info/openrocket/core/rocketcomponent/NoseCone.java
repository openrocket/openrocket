 ...
 * fore radius == 0.
 * <p>
 * The normal nose cone can be converted to a tail cone by setting the
 * {@link #isFlipped} parameter.
...
public class NoseCone extends Transition implements InsideColorComponent {
	...
	/**
	 * Returns the base radius of the nose cone (independent of whether the nose
	 * cone is flipped or not).
	 * This method should be used over {@link #getAftRadius()} because it works for
	 * both normal and flipped nose cones.
	 */
	...
	/**
	 * Sets the base radius of the nose cone (independent of whether the nose cone
	 * is flipped or not).
	 * This method should be used over {@link #setAftRadius(double)} because it
	 * works for both normal and flipped nose cones.
	 */
	...
	/**
	 * Returns whether the base radius of the nose cone takes it settings from the
	 * previous/next component
	 * (independent of whether the nose cone is flipped or not).
	 * This method should be used over {@link #isAftRadiusAutomatic()} because it
	 * works for both normal and flipped nose cones.
	 */
	...
	/**
	 * Sets whether the base radius of the nose cone takes it settings from the
	 * previous/next component
	 * (independent of whether the nose cone is flipped or not).
	 * This method should be used over {@link #setAftRadiusAutomatic(boolean)}
	 * because it works for both normal and flipped nose cones.
	 */
	...
	/**
	 * Returns the shoulder length, regardless of how the nose cone is flipped
	 * (independent of whether the nose cone is flipped or not).
	 * This method should be used over {@link #getAftShoulderLength()} because it
	 * works for both normal and flipped nose cones.
	 */
	...
	/**
	 * Sets the shoulder length (independent of whether the nose cone is flipped or
	 * not).
	 * This method should be used over {@link #setAftShoulderLength(double)} because
	 * it works for both normal and flipped nose cones.
	 */
	...
	/**
	 * Returns the shoulder radius (independent of whether the nose cone is flipped
	 * or not).
	 * This method should be used over {@link #getAftShoulderRadius()} because it
	 * works for both normal and flipped nose cones.
	 */
	...
	/**
	 * Returns the shoulder thickness (independent of whether the nose cone is
	 * flipped or not).
	 * This method should be used over {@link #getAftShoulderThickness()} because it
	 * works for both normal and flipped nose cones.
	 */
	...
	/**
	 * Sets the shoulder thickness (independent of whether the nose cone is flipped
	 * or not).
	 * This method should be used over {@link #setAftShoulderRadius(double)} because
	 * it works for both normal and flipped nose cones.
	 */
	...
	/**
	 * Returns the shoulder cap (independent of whether the nose cone is flipped or
	 * not).
	 * This method should be used over {@link #isAftShoulderCapped()} because it
	 * works for both normal and flipped nose cones.
	 */
	...
	/**
	 * Sets the shoulder cap (independent of whether the nose cone is flipped or
	 * not).
	 * This method should be used over {@link #setAftShoulderCapped(boolean)}
	 * because it works for both normal and flipped nose cones.
	 */
	...
	/**
	 * Return true if the nose cone is flipped, i.e. converted to a tail cone, false
	 * if it is a regular nose cone.
	 */
	...
	/**
	 * Set the nose cone to be flipped, i.e. converted to a tail cone, or set it to
	 * be a regular nose cone.
	 * 
	 * @param flipped     if true, the nose cone is converted to a tail cone, if
	 *                    false it is a regular nose cone.
	 * @param sanityCheck whether to check if the auto radius parameter can be used
	 *                    for the new nose cone orientation
	 */
	 ...
	 * be a regular nose cone.
	 * 
	 * @param flipped if true, the nose cone is converted to a tail cone, if false
	 *                it is a regular nose cone.
	 */
	...
	protected void loadFromPreset(ComponentPreset preset) {
		// We first need to unflip, because the preset loading always applies settings
