 ...
 * the aerodynamics of a rocket, only its mass properties (though the location
 * of the
 * components is not enforced to be within external components). Internal
 * components
 * are always attached relative to the parent component, which can be internal
 * or
