...
public interface Motor {
	...
	/**
	 * Ejection charge delay value signifying a "plugged" motor with no ejection
	 * charge.
	 ...
	 * burn time to be the time which the motor produces over 5% of its maximum
	 * thrust.
	 */
	...
	/**
	 * Returns the motor name, based on whether the preference is to use the
	 * designation or common name.
	 * 
	 * @return the motor designation, if the preference is to use the designation,
	...
	/**
	 * Returns the motor name, including a delay, based on whether the preference is
	 * to use the designation or common name.
	 * 
	 * @return the motor designation, including a delay, if the preference is to use
	 *         the designation, otherwise the common name.
	 */
	...
	/**
	 * Return an estimate of the burn time of this motor, or NaN if an estimate is
	 * unavailable.
	 */
	public double getBurnTimeEstimate();

	/**
	 * Return an estimate of the average thrust of this motor, or NaN if an estimate
	 * is unavailable.
	 */
	public double getAverageThrustEstimate();

	/**
	 * Return an estimate of the maximum thrust of this motor, or NaN if an estimate
	 * is unavailable.
	 */
	public double getMaxThrustEstimate();

	/**
	 * Return an estimate of the total impulse of this motor, or NaN if an estimate
	 * is unavailable.
	 */
	 ...
	 * 
	 * this is probably a badly-designed way to expose the thrust, but it's not
	 * worth worrying about until
