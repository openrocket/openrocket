...
public abstract class Message implements Cloneable {
    ...
    /**
     * Returns the message text (without message source information). The text
     ...
     * 
     * @return the rocket component(s) that are the source of this warning. Returns
     *         null if no sources are specified.
     */
