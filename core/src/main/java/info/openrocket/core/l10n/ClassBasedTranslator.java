...
/**
 * A translator that prepends a pre-defined class name in front of a translation
 * key
 * and retrieves the translator for that key, and only if that is missing
 * reverts to
 * the base key name. The base class name can either be provided to the
 * constructor
