...
public interface DecalImage extends ChangeSource, Comparable<DecalImage> {
	...
	/**
	 * Checks whether this DecalImage should be ignored when saving the OpenRocket
	 * document.
	 * 
	...
	/**
	 * Sets the flag to know whether this DecalImage should be ignored when saving
	 * the OpenRocket document.
	 * 
