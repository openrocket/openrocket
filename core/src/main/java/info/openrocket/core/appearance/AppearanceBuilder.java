...
public class AppearanceBuilder extends AbstractChangeSource {
	...
	/**
	 * List of appearance builders that will set their appearance properties to the
	 * same as the current appearance
	 */
	...
	*/
	 ...
	 *
	 * @param opacity new opacity value expressed in a percentage, where 0 is fully
	...
	public void setOpacity(double opacity) {
		...
		// Instead of simply setting the alpha, we need to create a new color with the
		// new alpha value, otherwise undoing
