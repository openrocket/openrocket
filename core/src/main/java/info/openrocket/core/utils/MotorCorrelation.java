...
public class MotorCorrelation {
	...
	/**
	 * Return a measure of motor similarity. The measure is a value between 0.0 and
	 * 1.0.
	 * The larger the value, the more similar the motor thrust curves are, for value
	 * 1.0 they
	 * are identical.
	 * <p>
	 * This method takes into account the thrust curve shape, average thrust, burn
	 * time and
	...
	/**
	 * Compute the cross-correlation of the thrust curves of the two motors. The
	 * result is
	 * a double between 0 and 1 (inclusive). The closer the return value is to one
	 * the more
