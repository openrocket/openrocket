...
public class Simulation implements ChangeSource, Cloneable {
	...
	/**
	 * Create a new simulation for the rocket. Parent document should also be
	 * provided.
	 * The initial motor configuration is taken from the default rocket
	 * configuration.
	 *
	...
	/**
	 * Set the motor configuration ID. If this id does not yet exist, it will be
	 * created.
	 * 
	 ...
	 * may be modified freely, and the status of the simulation will change to
	 * reflect
	 * the changes.
	 *
	 ...
	 * Simulate the flight.
	 *
	 * @param additionalListeners additional simulation listeners (those defined by
	 *                            the simulation are used in any case)
	...
	/**
	 * Return a string describing the motor configuration of the previous
	 * simulation,
	 * or <code>null</code> if this simulation has not been run.
	 *
	 * @return a description of the motor configuration of the previous simulation,
	 *         or
	 *         <code>null</code>.
	 */
	 ...
	 * @return a new deep copy of the simulation and rocket with the same conditions
	 *         and properties.
	 */
