...
public final class MainShaderUniforms {
	...
	MainShaderUniforms(GLShader shader) {
		...
		this.selectionColor = shader.requireUniformLocation("selectionColor");
		this.isSelected = shader.requireUniformLocation("isSelected");
		...
		this.specularTintFactor = shader.requireUniformLocation("specularTintFactor");
		...
		this.hasDecal = shader.requireUniformLocation("hasDecal");
		this.decalTransformMatrix = shader.requireUniformLocation("decalTransformMatrix");
		this.decalSampler = shader.requireUniformLocation("decalSampler");
		this.decalSurfaceMask = shader.requireUniformLocation("decalSurfaceMask");
