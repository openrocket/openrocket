...
public class RecoveryConfigurationPanel extends FlightConfigurablePanel<RecoveryDevice>
{
   ...
   protected JTable initializeTable() {
      //// Recovery selection
      FlightConfigurableTableModel<RecoveryDevice> recoveryTableModel = new FlightConfigurableTableModel<>(RecoveryDevice.class, rocket);
   ...
   private class RecoveryTableCellRenderer extends FlightConfigurablePanel<RecoveryDevice>.FlightConfigurableCellRenderer
   {
