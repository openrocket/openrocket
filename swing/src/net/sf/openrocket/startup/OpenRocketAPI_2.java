...
public class OpenRocketAPI_2 {
	...
	private FlightDataBranch m_CFDB = null;
	...
	public int StartSimulation(){
		...
		m_CFlightData=temp;
		//This is the object where Everything is stored over the simulation.
		m_CFDB = m_CStatus.getFlightData();
